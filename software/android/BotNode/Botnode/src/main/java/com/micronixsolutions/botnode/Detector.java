...
public class Detector {
    ...
    public void detect(Mat origImg, Mat processedImg) {
        nativeDetect(mNativeObj, origImg.getNativeObjAddr(), processedImg.getNativeObjAddr());
    }
    ...
    private static native long nativeDetect(long thiz, long origImg, long processedImg);
}
